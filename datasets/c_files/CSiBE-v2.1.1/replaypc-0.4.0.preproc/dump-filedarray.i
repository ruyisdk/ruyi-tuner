...
static int dump_filedarray_file(FILE * fp)
{
    ...
    do {
        count = (( items_left )<(  4096/444 )?( items_left ):(  4096/444 )) ;
        for (i = 0; i < count; i++) {
