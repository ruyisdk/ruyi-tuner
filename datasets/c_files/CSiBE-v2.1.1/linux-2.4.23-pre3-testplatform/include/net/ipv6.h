...
/* extern struct ipv6_mib		ipv6_statistics[NR_CPUS*2]; --- Modified by CSiBE */
extern struct ipv6_mib		*ipv6_statistics;
#define IP6_INC_STATS(field)		SNMP_INC_STATS(ipv6_statistics, field)
#define IP6_INC_STATS_BH(field)		SNMP_INC_STATS_BH(ipv6_statistics, field)
#define IP6_INC_STATS_USER(field) 	SNMP_INC_STATS_USER(ipv6_statistics, field)
/* extern struct icmpv6_mib	icmpv6_statistics[NR_CPUS*2]; --- Modified by CSiBE */
...
/* extern struct udp_mib		udp_stats_in6[NR_CPUS*2]; --- Modified by CSiBE */
