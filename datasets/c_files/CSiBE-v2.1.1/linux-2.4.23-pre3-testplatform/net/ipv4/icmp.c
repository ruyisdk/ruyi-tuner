...
/* struct icmp_mib icmp_statistics[NR_CPUS*2]; --- Modified by CSiBE */
struct icmp_mib icmp_statistics_renamed_by_CSiBE[NR_CPUS*2];
struct icmp_mib *icmp_statistics=icmp_statistics_renamed_by_CSiBE;

/* An array of errno for error messages from dest unreach. */
/* RFC 1122: 3.2.2.1 States that NET_UNREACH, HOS_UNREACH and SR_FAIELD MUST be considered 'transient errs'. */

/* struct icmp_err icmp_err_convert[] --- Modified by CSiBE */
struct icmp_err icmp_err_convert_renamed_by_CSiBE[] = {
...
struct icmp_err *icmp_err_convert=icmp_err_convert_renamed_by_CSiBE;
...
static struct icmp_control icmp_pointers[NR_ICMP_TYPES+1] = {
/* ECHO REPLY (0) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutEchoReps, &icmp_statistics_renamed_by_CSiBE[0].IcmpInEchoReps, icmp_discard, 0 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
/* DEST UNREACH (3) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutDestUnreachs, &icmp_statistics_renamed_by_CSiBE[0].IcmpInDestUnreachs, icmp_unreach, 1 },
/* SOURCE QUENCH (4) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutSrcQuenchs, &icmp_statistics_renamed_by_CSiBE[0].IcmpInSrcQuenchs, icmp_unreach, 1 },
/* REDIRECT (5) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutRedirects, &icmp_statistics_renamed_by_CSiBE[0].IcmpInRedirects, icmp_redirect, 1 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
/* ECHO (8) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutEchos, &icmp_statistics_renamed_by_CSiBE[0].IcmpInEchos, icmp_echo, 0 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].IcmpInErrors, icmp_discard, 1 },
/* TIME EXCEEDED (11) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutTimeExcds, &icmp_statistics_renamed_by_CSiBE[0].IcmpInTimeExcds, icmp_unreach, 1 },
/* PARAMETER PROBLEM (12) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutParmProbs, &icmp_statistics_renamed_by_CSiBE[0].IcmpInParmProbs, icmp_unreach, 1 },
/* TIMESTAMP (13) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutTimestamps, &icmp_statistics_renamed_by_CSiBE[0].IcmpInTimestamps, icmp_timestamp, 0  },
/* TIMESTAMP REPLY (14) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutTimestampReps, &icmp_statistics_renamed_by_CSiBE[0].IcmpInTimestampReps, icmp_discard, 0 },
/* INFO (15) */
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].dummy, icmp_discard, 0 },
/* INFO REPLY (16) */
 { &icmp_statistics_renamed_by_CSiBE[0].dummy, &icmp_statistics_renamed_by_CSiBE[0].dummy, icmp_discard, 0 },
/* ADDR MASK (17) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutAddrMasks, &icmp_statistics_renamed_by_CSiBE[0].IcmpInAddrMasks, icmp_address, 0  },
/* ADDR MASK REPLY (18) */
 { &icmp_statistics_renamed_by_CSiBE[0].IcmpOutAddrMaskReps, &icmp_statistics_renamed_by_CSiBE[0].IcmpInAddrMaskReps, icmp_address_reply, 0 }
};
