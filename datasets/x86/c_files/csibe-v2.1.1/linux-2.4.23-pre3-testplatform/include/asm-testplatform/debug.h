...
#define INTERNAL_ERRMSG(x,y...) "E" "__FILE_" "%d: " x, __LINE__, y
#define INTERNAL_WRNMSG(x,y...) "W" "__FILE_" "%d: " x, __LINE__, y
#define INTERNAL_INFMSG(x,y...) "I" "__FILE_" "%d: " x, __LINE__, y
#define INTERNAL_DEBMSG(x,y...) "D" "__FILE_" "%d: " x, __LINE__, y
