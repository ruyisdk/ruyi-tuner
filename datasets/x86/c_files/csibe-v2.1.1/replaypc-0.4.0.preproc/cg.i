                               ...
                               int varsize)
{
    ...
    *pp = p;
    ...
    do { if (!( prog->record_len == 0 ||
           ((offset + 28 + 3) & 0xfffc) == prog->record_len )) { fprintf(stderr , "Unexpected %s %s:%d\n", "prog->record_len == 0 || ((offset + 28 + 3) & 0xfffc) == prog->record_len", "cg.c", 101); if (0 ) (exit(-1)); } } while(0) ;
