...
struct mapping device_mapping_renamed_by_CSiBE[] = {   
    { 0, "Standard" },
    { 1, "A Lineup" },
    { 2, "B Lineup" },
    { 3, "C" },
...
struct mapping * device_mapping=device_mapping_renamed_by_CSiBE;   

struct mapping device_bitmapping_renamed_by_CSiBE[] = {   
    { 1 << 0, "Standard" },
    { 1 << 1, "A Lineup" },
    { 1 << 2, "B Lineup" },
    { 1 << 3, "C" },
...
struct mapping *device_bitmapping=device_bitmapping_renamed_by_CSiBE;

struct mapping service_tier_mapping_renamed_bs_CSiBE[] = {
    { 1, "Basic" },
    { 2, "Extended Basic" },
    { 3, "Premium" },
    { 4, "Pay-Per-View" },
...
struct mapping *service_tier_mapping=service_tier_mapping_renamed_bs_CSiBE;

