...
# 49 "../../src/api/tcpip.c" 2


static void (* tcpip_init_done)(void *arg) = ((void *)0) ;
...
{
  tcp_tmr();
  sys_timeout(100 , (sys_timeout_handler)tcpip_tcp_timer, ((void *)0) );
}
...
tcpip_init(void (* initfunc)(void *), void *arg)
{
  ...
  mbox = sys_mbox_new();
  sys_thread_new((void *)tcpip_thread, ((void *)0) );
}
