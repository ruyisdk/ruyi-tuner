...

struct mapping addressbook_entry_flag_bitmapping_renamed_by_CSiBE[] = {
    { 1 << 0, "Blocked" },
    { -1, ((void *)0)  },
};
struct mapping *addressbook_entry_flag_bitmapping=addressbook_entry_flag_bitmapping_renamed_by_CSiBE;

