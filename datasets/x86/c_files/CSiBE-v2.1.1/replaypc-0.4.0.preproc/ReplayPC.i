...
{ 
    ...
    { 
        printf("\n");
        printf("ReplayPC V0.4.0, built on " "Feb 10 2004" " " "12:00:47" "\n"); 
...
void GetDir(char *IPAddress)
{
    ...
    while (cur && *cur) {
        ...
        if ((TimeStamp = (time_t)strtoul(cur, ((void *)0) , 10)) > 0) {
...
void GetReplayGuide(char *IPAddress, int ToStdOut) 
{
    ...
    if (ToStdOut) {
        ...
        FILE * fp;
        if ((fp = fopen("guide.dat", "wb")) == ((void *)0) ) { 
...
static void GetMpgCallback(unsigned char * buf, size_t len, void * vd)
{
    ...
    fprintf(stderr , "\r%""ll" "d KB received", data->byteswritten/1024);
    fflush(stderr );
}
...
void GetMpgFile(char *IPAddress, char *FileName, int ToStdOut) 
{
    ...
    if (ToStdOut) {
        ...
        if ((data.out = fopen(FileName, "wb")) == ((void *)0) ) { 
...
void DoCommand(char *IPAddress, char *Command, int ToStdOut) 
{
    ...
    if (ToStdOut) {
        ...
        if ((data.out = fopen("result.dat", "wb")) == ((void *)0) ) { 
