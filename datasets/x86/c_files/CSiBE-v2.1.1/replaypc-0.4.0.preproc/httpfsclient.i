                           ...
                           va_list args) 
{
    ...
    argp = argbuf;
    argl = 0;
    while ((tag = ( args  = (__gnuc_va_list) ((char *) ( args ) + (((sizeof (   char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ),	*((  char *  *) (void *) ((char *) ( args ) - (((sizeof (   char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ))) ) != ((void *)0) ) {
        value = ( args  = (__gnuc_va_list) ((char *) ( args ) + (((sizeof (   char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ),	*((  char *  *) (void *) ((char *) ( args ) - (((sizeof (   char *  ) + sizeof (int) - 1) / sizeof (int)) * sizeof (int)) ))) ;
        if (value == ((void *)0) ) {
            continue;
        }
        if (argno)
                            ...
                            const char * command, ...)
{
    ...
    ( ap  = ((__gnuc_va_list) __builtin_next_arg (  command ))) ;
    ...
    if (e) {
        *presult = strdup(e+1);
        rtv_status = strtoul(tmp, ((void *)0) , 10);
        free(tmp);
        return rtv_status;
...
static void hfs_callback(unsigned char * buf, size_t len, void * vd)
{
    ...
    if (data->firsttime) {
        ...
        if (e)
            *e = '\0';
        data->status = strtoul(buf, ((void *)0) , 16);
