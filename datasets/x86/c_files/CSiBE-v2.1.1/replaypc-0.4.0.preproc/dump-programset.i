...
static int dump_programset_file(FILE * fp)
{
    ...
    while (fread(buffer, 8, 1, fp)) {
        ...
        do { if (!( bigbuf != ((void *)0)  )) { fprintf(stderr , "Unexpected %s %s:%d\n", "bigbuf != NULL", "dump-programset.c", 38); if (0 ) (exit(-1)); } } while(0) ;
