...
# 492 "/SYS/include/bits/confname.h" 3
...
# 163 "/SYS/include/getopt.h" 3

# 172 "/SYS/include/getopt.h" 3
...
# 1 "../../src/arch/unix/include/netif/tapif.h" 1
...
# 1 "../../src/arch/unix/include/netif/tunif.h" 1
...
# 1 "../../src/arch/unix/include/netif/unixif.h" 1
...
# 1 "../../src/arch/unix/include/netif/dropif.h" 1
...
# 1 "../../src/arch/unix/include/netif/pcapif.h" 1
...
tcp_timeout(void *data)
{
  ...
  sys_timeout(5000, tcp_timeout, ((void *)0) );
}
...
# 118 "simhost.c"
  ...
  ( &gw )->addr = htonl(((u32_t)(  192  & 0xff) << 24) | ((u32_t)( 168  & 0xff) << 16) | ((u32_t)( 0  & 0xff) << 8) | (u32_t)( 1  & 0xff)) ;
  ( &ipaddr )->addr = htonl(((u32_t)(  192  & 0xff) << 24) | ((u32_t)( 168  & 0xff) << 16) | ((u32_t)( 0  & 0xff) << 8) | (u32_t)( 2  & 0xff)) ;
  ...
  ( &gw )->addr = htonl(((u32_t)(  127  & 0xff) << 24) | ((u32_t)( 0  & 0xff) << 16) | ((u32_t)( 0  & 0xff) << 8) | (u32_t)( 1  & 0xff)) ;
  ( &ipaddr )->addr = htonl(((u32_t)(  127  & 0xff) << 24) | ((u32_t)( 0  & 0xff) << 16) | ((u32_t)( 0  & 0xff) << 8) | (u32_t)( 1  & 0xff)) ;
  ( &netmask )->addr = htonl(((u32_t)(  255  & 0xff) << 24) | ((u32_t)( 0  & 0xff) << 16) | ((u32_t)( 0  & 0xff) << 8) | (u32_t)( 0  & 0xff)) ;
...
main(int argc, char **argv)
{
  ...
  sys_thread_new((void *)(main_thread), ((void *)0) );
  pause();
  return 0;
}
