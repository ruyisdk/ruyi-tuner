...
#ifdef DEBUG
#define dbg(format, arg...) printk(KERN_DEBUG "__FILE_" ": " format "\n" , ## arg)
#else
#define dbg(format, arg...) do {} while (0)
#endif
#define err(format, arg...) printk(KERN_ERR "__FILE_" ": " format "\n" , ## arg)
#define info(format, arg...) printk(KERN_INFO "__FILE_" ": " format "\n" , ## arg)
#define warn(format, arg...) printk(KERN_WARNING "__FILE_" ": " format "\n" , ## arg)
