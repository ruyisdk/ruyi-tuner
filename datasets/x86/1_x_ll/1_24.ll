; ModuleID = '/tmp/tmprq13re4_.cpp'
source_filename = "/tmp/tmprq13re4_.cpp"
...
for.end:                                          ; preds = %for.cond2
  ...
  %call7 = call noundef i32 @_Z3fffiiii(i32 noundef 1, i32 noundef %sub, i32 noundef 1, i32 noundef %11)
  %12 = load i32, ptr @l, align 4, !tbaa !5
  %13 = load i32, ptr @x, align 4, !tbaa !5
  %call8 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12, i32 noundef %13)
  br label %for.inc9
...
define dso_local noundef i32 @_Z3fffiiii(i32 noundef %k, i32 noundef %w, i32 noundef %t, i32 noundef %x) #3 {
entry:
...
if.then:                                          ; preds = %for.body
  ...
  %9 = load i32, ptr %x.addr, align 4, !tbaa !5
...
if.then7:                                         ; preds = %if.end
  ...
  %13 = load i32, ptr %w.addr, align 4, !tbaa !5
  %14 = load i32, ptr %i, align 4, !tbaa !5
  %15 = load i32, ptr %x.addr, align 4, !tbaa !5
  %call = call noundef i32 @_Z3fffiiii(i32 noundef %add, i32 noundef %13, i32 noundef %14, i32 noundef %15)
  br label %if.end8

if.end8:                                          ; preds = %if.then7, %if.end
  %16 = load i32, ptr %x.addr, align 4, !tbaa !5
  ...
  store i32 %mul, ptr %x.addr, align 4, !tbaa !5
  br label %if.end11
