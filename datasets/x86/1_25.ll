; ModuleID = '/tmp/tmp2krndhct.cpp'
source_filename = "/tmp/tmp2krndhct.cpp"
...
for.end:                                          ; preds = %for.cond2
  ...
  %call7 = call noundef i32 @_Z3fffiii(i32 noundef %sub, i32 noundef 1, i32 noundef %11)
...
define dso_local noundef i32 @_Z3fffiii(i32 noundef %w, i32 noundef %t, i32 noundef %x) #3 {
entry:
...
if.then7:                                         ; preds = %if.end
  ...
  %call = call noundef i32 @_Z3fffiii(i32 noundef %12, i32 noundef %13, i32 noundef %14)
  br label %if.end8
