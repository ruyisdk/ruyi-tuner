...
define dso_local noundef signext i32 @_Z8mystrlenPKc(ptr noundef %0) #0 {
...
; Function Attrs: minsize mustprogress noinline nounwind uwtable
define dso_local noundef signext i32 @_Z8classifyc(i8 noundef zeroext %0) #0 {
...
define dso_local noundef signext i32 @main() #1 {
  ...
  %9 = call signext i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %8) #3
  %10 = getelementptr inbounds [64 x i8], ptr %2, i64 0, i64 0
  %11 = call noundef signext i32 @_Z8mystrlenPKc(ptr noundef %10) #3
  store i32 %11, ptr %3, align 4
...
16:                                               ; preds = %12
  ...
  %19 = getelementptr inbounds [64 x i8], ptr %2, i64 0, i64 %18
  %20 = load i8, ptr %19, align 1
  %21 = call noundef signext i32 @_Z8classifyc(i8 noundef zeroext %20) #3
...
38:                                               ; preds = %12
  ...
  %41 = call signext i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef signext %39, i32 noundef signext %40) #3
  ret i32 0
}
